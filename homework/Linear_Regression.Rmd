...
This scatterplot has a fairly strong negative relationship between math scores and FARMS percentage. As the FARMS percentage increases the scores decrease. This scatterplot shows a much stronger relationship than the in class scatterplot. 
...
I would say this model is worth exploring. THe P-Value is statistically signifigant, and the R-Squared value indicates that the model is at least decent. Especailly compared to the in class assignment.
...
Stedwick has the most negative residual, and Wayside has the most positive residual. Stedwick has large hispanic population according to the census data, Wayside has a majority white population according to the census data. This alone doesn't tell us much, but the majority white population may have higher access to education resources which would lead to better math scores compared to the average.
...
I would say that there is a statistical model that backs up the board members claims to some degree. However, I would say that a story just based on this model wouldn't be accurate. The free and reduced meals might be going to schools where the material conditions of the students is much lower, and it's that fact that makes the test scores lower not the meals. Any story pich would need to include this context in my opinion.
