...
Yes the chi-square statistic is greater than the critical value so we would reject the null hypothesis. 11.667 > 9.488
...
The biggest discrepancy seems to be that more students performed at an extremely high level and less students performed poorly. 20 more students than expected got an A and 20 less students than expected got a C. I would say this is where the majority of the difference is coming from (more students than expected also got a B and less students than expected got an F but I don't think these differences were as big as the A's and C's). I think the first thing I would ask is if the curriculum for that class changed and if that change made the class easier. The second thing I would ask is if the instructors grading system changed and resulted in less students doing really poorly. I then also ask if this discrespnecy year to year is not unusual. Maybe this class is a uniquely talented class, and when classes like that come through the averages are just higher.
