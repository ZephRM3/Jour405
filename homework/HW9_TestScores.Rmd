...
Just looking at the data I would have to say yes. It looks like every score is higher than the previous mean.
...
The mean score is a couple points higher than the old one and the standard deviation is tighter. The biggest question now is whether we can definiteively prove that the new program is not, not the reason the scores have increased if that makes sense.
...
my_fill_color <- "green" # Replace with a color name like "royalblue", "darkgreen", etc.
...
Test Averages have Increased After New Program
...
The P value determines whether a statistic is considered "statistically significant." A P value of .05 or less is considered statistically significant usually. our number in this assignmnet is .00003435 so it fits that designation. 
...
Headline:
Statistics show that the states new program may improve reading test scores.

We would need to do more research to prove that the new program itself has casued this increase, but right now we can say for sure that it's not lowering them, and their is a correlation that might indicate improvement.


### Reflection Question 6:
What metrics or outcomes beyond test scores might be important to track for assessing reading performance?

-How much a kid is reading in their free time
-Are they keeping up in other classes
-Can they read in a scneario that's not test based or are they being just taught to the test
