...
The average of this data looks like it's risen ever so slighlty since 2017. Also the drop off during the pandemic is quite visible, and looks like it was followed by not just a return to normal but a slight spike for at least a year. So you have the gradual rise angle, the five years post pandemic angle.
...
Monday-Thursday are all about the same on the low end, while the weekends average noticeably more, especially Friday. I'd imagine this is related to drivers being out later on these days arnd perhaps there being higher rates of intoxicated driving on the weekends which leads to more accidents.
...
Well I would want to say the reason 10/29/21 had so many accidents was everyone in Maryland celebrating my 18th birthday too hard, but sadly it seems that the reason there were that many accidents was a nasty storm, that was causing flooding all over Maryland/DC and closed schools in PG County for the day. This weather event I think definitely makes this day somewhat of an outlier which is important to consider, but perhaps it could be used as an example of just how badly weather and road conditions can effect peoples ability to drive safely.
...
When you just look at the most unusual days periord the list is dominated by Friday-Sunday days (mostly just Friday/Saturday). This makes sense because in general these are going to be the days where there are likely to be the most accidents and thus a higher likelihood that there will be an outlier day. When you look at the day of the week, the opposite is true. There are more likely to be "extreme" scores on the weekdays because the average is lower on those days. In my opinion as a journalist I care more about the just regular extreme Z score data, because I think the story about there being 10 more accidents than usual on a Friday night is more important than there being three more accidents than normal on a Tuesday.
...
Ocotber has the highest average and January has the lowest average. I wonder how much this data has to do with college students, and their drinking habits, or just more people being in Prince Geroges county in general. Because it kind of looks like the rises and falls in this chart roughly match the start and and end of the semesters schedule. 
...
ANSWER HERE
Almost all of the outliers occur on Friday and Saturday.
...
PG car crash rate coincide with university schedule

Car crash rates in PG County appear to somewhat align with the academic years of students at the University of Maryland. Peaking in Ocotber and May.

I think the most important people to aget as sources for this story would be the police officers dealing with this. They can confirm and give context as to who gets pulled over and why.
