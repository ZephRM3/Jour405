...
Older/retired voters who are college educated might be more likely to have the time or the want to fill out voting surveys compared to younger people just out of highschool who are still in college or working.
...
College educated voters are almost 20% more likely to vote in this years election than non-college educated voters, according to statistics.
...
Not really this graph seems off and only seems to show the the unweighted percentage.
...
This data shows that college educated voters are much more likely to vote in the upcoming elections. Voters who are not college educated are much less likely to vote in comparison, and voters with some college education in the middle. 

Weighting the results really did not change the results of the college educated or partially educated voters. However, it did show that when weighted correctly, non college educated voters are even less likely to vote.

This shows that in the newsroom it's important to understand what groups need to be weighted correctly. College educated voters are most likely over represented in these polls and are thus likely to be at least somewhat spot on, but non college educated are not, and when that group is weighted correctly a 3 point swing in the data could change the results of the election or shift projections enormously.
...
Because without weighting certain sub groups correctly the data could be reported incorrectly. 

2. How might the differences between weighted and unweighted results affect how you would report on this data?

If a set of data changes by a huge margin when weighted correctly that might tell me that something about that data is off or might need context added when reported. Perhaps that difference could itself be a story.
...
Credibility of the pollster running the data (are they known for providing good data and have they polled these populations before).

The calculations that went into the data, like what we see above.
