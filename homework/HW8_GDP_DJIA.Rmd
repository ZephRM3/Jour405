...
```{r}
GDP_Data |> summarise(correlation = cor(GDP, DJIA))
```
...
It seems that the higher the GDP the higher the DJIA. The correlation between these two things s very strong (I calculated it and it's .95). The data points cling veery clealry to a very positive correlation.
