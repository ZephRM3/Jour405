...
I would say that the differences are actually not that big. There are a few less 5 star movies than expected and good amount more 2 star movies than expected, so maybe the quality of movies this year was just not quite as high as was anticipated.
...
Statistically speaking we should rejet the Null hypothesis because the Chi-Square value is higher than the critical value. This means that the observed results are significantly different than what we would expect.
