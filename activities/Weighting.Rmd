...
.23 would poteintally be over represented, and 3.04 could be underrepresented

3. Why might some respondents be weighted more heavily than others?

Because they could come from a sub group that is less likely to respond or doesn't respond as often.
...
The rarely/never vote category.

2. How might these differences affect reporting on likely voter turnout?

Weighting the vote would probably make reporters skeptical of how much these unlikely to vote voters are actually going to come out to vote.
...
People les likely to vote are also less likely to respond to a voting survey so the responses you get from them need to be given more weight.
