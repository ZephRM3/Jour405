...
The bigger the sample the closer the mean gets to representing the mean of the whole population. The mean of the sample of 100 is very close to the actual mean of the total population. much closer than the smaller samples.
