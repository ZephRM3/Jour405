...
The association is pretty weak, but looks like it's vaguely positive.
...
I would say no. The R-Squared score is really bad which leads me to believe that this model isn't a good indicator of what we are trying to find. I would say that the FARMS percentage doesn't have a statically provable impact on math scores in most cases.
...
The majority of the biggest differences are coming in on the negative side meaning that most schools are under performing. 
...
I would say that why the model doesn't show that FARMS has an impact on test scores in a positive way, it also in no way proves that it makes test scores worse. 

I would pitch a story about what the board member proposed as something like, "Data shows that Free and Reduced meals don't make test scores better, but they also don't make them worse. The math doesn't back this board members proposal.
