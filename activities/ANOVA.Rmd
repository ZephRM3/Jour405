...
The differences between public and private schools are closer than I thought they would be on average. The mean score was only about 75 points different. The difference between public/private and community is much greater, and actually bigger than I expected. This difference seems to come from the minimum scores that are excpeted at community college which is significantly lower than the public/private colleges.
...
Yes there is a significant difference between SAT scores across different types of colleges. The F score found after doing an ANOVA test was 284.3 which is hugely significant. Additionally further testing showed massive differences between different pairings of schools. Public and Private schools scores are much higher than community schools. 366, and 292 points on average. Private schools on average have 75 point higher scores than public schools though.

This is how different types of schools view SAT scores

Colleges do care about sat scores acording to statistics. Data shows massive differences between the average scores accepted at community college, public colleges, and private schools. Most starkly shown by the over 350 difference in scores between community colleges and private schools.
