...
Data shows that there is evidence the new transit line has increased housing prices. Before the completion of new line the average price of a house was $285,000. That price has risen to an average of over $300,000 since. Analysis of the data proves that their is a correlation between the completion of the construction project and the increase in prices. However, whether other factors played a role in this increase is not yet known.
