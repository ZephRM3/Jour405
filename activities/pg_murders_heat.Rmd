...
There does appear to be a fairly strong positive correlation between temperature and the number of murders that happen. The data does appear to cling pretty hard to center around a postive linear line.
