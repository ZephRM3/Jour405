...
I would say that the average is probably somewhere close to 11 calls a day based on the graph. If I were to draw horizontal lines then I would draw my lines at 6 and 16 as this I think would be roughly two standard deviations away.
...
I didn't put my lines high enough or low enough. I was generally kind if close and I think my reasoning was correct I just underestimated how big the difference needs to be for it fall out of the normal score.
...
ANSWER HERE
Tuesday October 4, had over double the number of calls than are average. A difference this much higher, is a very statistically rare event.
...
The difference between the Winter and the Summer months is what stood out to me the most. Why do the average overdose calls trend down as the weather gets colder? Is it a supply question are there less drugs on the street, or are less people buying drugs, or are less overdoses getting called in. I would probably want to call the police or experts at rehab centers and people on the street about this too see if what we found through the data is true on the ground. I would tell mey editor that I have a potential story about drug problems in Baltimore County, and how those overdoses are reported. The most interesting thing I think would be whether drug overdoses just go unreported in the Winter months. 
